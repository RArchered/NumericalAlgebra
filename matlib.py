...
if __name__ == '__main__':
    '''
    l1 = [[1, 0], [3, 4]] #lower triangular square matrix
    l2 = [[5, 5], [5, 5]]
    m1 = Matrix(l1)
    m2 = Matrix(l2)
    print('m1 + m2', (m1 + m2))
    ...
    print('v1 - v2', (v1 - v2))
    print('m1 / v3', (m1 / v3))
    print('Gauss', gauss_elimination([[0.001, 0], [1.00, 0]]))
    '''
    
    '''m = Matrix([[3, 5, 7], [2, 4, 8], [1, 7, 5]])
    v = Vector([1, 3, 9])
    print('m / v = ', m / v)
    
    A = Matrix([[16, 4, 8, 4], [4, 10, 8, 4], [8, 8, 12, 10], [4, 4, 10, 12]])
    b = Vector([32, 26, 38, 30])
    print(A.improved_solve_equations_by_cholesky(b))
    '''

    A = [[1, 1], [0, 2]]
    #print(special_norm_1_by_optimization(A))
